<template>
    <div class="main_content">
                ...
                <vs-card>
                    ...
                    <template #text>
                        ...
                        <div class="buttons" id="fileinputblaWalls">
                            ...
                            <input @change="fixWalls" style="display:None;" type="file" ref="wallsInput" id="file"
                                name="file" accept=".dat,.json" />
                        </div>
                    </template>
                </vs-card>
                ...
                <vs-card>
                    ...
                    <template #text>
                        ...
                        <div class="buttons" id="fileinputbla">
                            ...
                            <input @change="convertToDots" style="display:None;" type="file" ref="dotsInput" id="file"
                                name="file" accept=".dat,.json" />
                        </div>
                    </template>
                </vs-card>
                ...
                <vs-card>
                    ...
                    <template #text>
                        <p>
                            ...
                            <br>
                            Use Beatlist, Modassistant or the playlist downloader to the right to download playlists.
                            <br>
                        </p>
                        ...
                        <div class="buttons">
                            ...
                            <a href="bsplaylist://playlist/https://ewoks.de/playlists/InRankingQueue.json" download>
                                <vs-button border style="min-width: 120px" primary animation-type="scale">
        ...
        <div class="col">
            ...
            <vs-alert color="primary">
                If you find or have other scripts that you'd like to get listed here let me know on discord.
            </vs-alert>
