<template>
    <Slider class="slider" v-model="newvalue" v-bind="$attrs" />
</template>
...
.slider-handle {
    ...
    &:focus {
        outline: none;
        box-shadow: 0 0 0 var(--slider-handle-ring-width, 3px) var(--slider-handle-ring-color, #1f1f1f30),
...
.slider-horizontal .slider-tooltip {
    ...
    left: 50%;
    bottom: calc(
        var(--slider-handle-height, 16px) + var(--slider-tooltip-arrow-size, 5px) + var(--slider-tooltip-distance, 3px)
    );
...
.slider-horizontal .slider-origin > .slider-tooltip {
    ...
    left: auto;
    bottom: calc(
        var(--slider-tooltip-arrow-size, 5px) + ((var(--slider-handle-height, 16px) - var(--slider-height, 6px)) / 2) +
...
.slider-vertical .slider-origin > .slider-tooltip {
    ...
    right: calc(
        var(--slider-tooltip-arrow-size, 5px) + var(--slider-height, 6px) +
            ((var(--slider-handle-height, 16px) - var(--slider-height, 6px)) / 2) + var(--slider-tooltip-distance, 3px)
    );
}
</style>
