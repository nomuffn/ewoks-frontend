  ...
  <div class="playlists">
    ...
    <div class="content flex justify-evenly flex-wrap">
      ...
      <div class="feature">
        ...
        <Message class="self-center mt-8 w-full" :closable="false">
          <p>Filters by various conditions across all maps on beatsaver and puts them into a playlist</p>
          <p>Database of all maps used for this only updates once a day</p>
        </Message>
        ...
        <div class="myrow search" style="padding-top: 10px">
          ...
          <InputText v-model="mapperInput" placeholder="Mapper name" @keyup.enter="addMapper" />
          <div v-if="mappers.length" class="mappers">
            <div v-for="mapper in mappers" :key="mapper" class="mapper">
...
export default {
  ...
  computed: {
    ...
    getMonthsDifference () {
      const date1 = new Date(this.gameReleaseDate * 1000)
      const difference = date1.getTime() - new Date()
