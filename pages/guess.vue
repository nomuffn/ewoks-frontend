<template>
  <div class="guess">
    <sub-header title="Guessing game" />
      ...
      <div class="flex flex-col mt-4 items-center flex-grow">
        ...
        <template v-else>
          <div class="flex flex-col mt-4">
            <p class="self-center font-bold text-2xl">
              Result
            </p>
            ...
            <div class="my-4 flex flex-col">
              <span>Gussed rank: <strong>#{{ rankGuess }}</strong></span>
              <span>Actual rank: <strong>#{{ actualRank }}</strong></span>
              <p class="font-bold">
            ...
            <div class="my-4 flex flex-col">
              <span>Gussed hmd: <strong>{{ hmdGuess && hmdGuess.value }}</strong></span>
              <span>Actual hmd: <strong>{{ actualHMD }}</strong></span>
              <p class="font-bold">
