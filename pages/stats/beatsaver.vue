  ...
  <div class="beatsaver">
    <div class="filter-container">
      <div class="filter">
        ...
        <div class="myrow">
          ...
          <InputText v-model="mapperName" placeholder="Mapper name" @keyup.enter="loadResults" />
        </div>
        <div class="myrow">
          <label>Order by</label>
          <Dropdown v-model="column" :options="allColumns" placeholder="Order by" scroll-height="400px" />
        </div>
        <div class="myrow">
        ...
        <div class="myrow">
          <div class="radios">
            ...
            <RadioButton id="desc" v-model="descending" value="-" />
            <label for="asc">Ascending</label>
            <RadioButton id="asc" v-model="descending" value="+" />
          </div>
        </div>
        <div class="myrow">
          <!-- // TODO loading -->
          <my-button class="w-full" :loading="true" @click="loadResults">
            Filter
          </my-button>
        </div>
      </div>
    ...
    <div class="cards-container">
      ...
      <div v-else class="cards vertical">
        <div v-for="(item, index) in getVisibleItems" :key="item.key" class="card">
          <div class="top">
            <div>
              <p class="mapper">
