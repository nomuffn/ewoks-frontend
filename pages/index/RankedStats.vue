    ...
    <div class="rankedstats">
        <div class="content">
            <div v-if="stats && mappers" class="col">
                ...
                <vs-alert color="warn">
                    Maybe the pp distribution has been wrong all the time and
                    nobody noticed :))
                    <br />
                    Just maybe!
                    <br />
                    But I can guarantee that it now makes sense!
                </vs-alert>
            ...
            <div class="col">
                ...
                <loading-spinner v-if="loading['mapperdist']" />
                <div v-if="mappers" class="cards">
                    <vs-card
                        :key="index"
            ...
            <div class="col">
                ...
                <loading-spinner v-if="loading['mapperdiffdist']" />
                <div v-if="mappersDiffs" class="cards">
                    <vs-card
                        :key="index"
                    ...
                    <vs-button
                        v-if="
                            visibleMappersDiffs <
                                Object.keys(mappersDiffs).length
                        "
                        class="showMore"
                        icon
            ...
            <div class="col">
                ...
                <loading-spinner v-if="loading['artistdist']" />
                <div v-if="artists" class="cards">
                    <vs-card
                        :key="index"
