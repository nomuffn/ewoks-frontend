  ...
  if (f) {
    ...
    r.onload = function (e) {
      ...
      try {
        ...
        if (obj._notes != null) {
          for (let i = 0; i < obj._notes.length; i++) {
            ...
            let c = 0
            for (let n = 0; n < obj._notes.length; n++) {
          ...
          if (config.bookmarks === true) { obj._customData._bookmarks = [] }
    ...
    r.onload = function (e) {
      ...
      try {
        ...
        if (obj._obstacles != null) {
          for (let i = 0; i < obj._obstacles.length; i++) {
            const wall = obj._obstacles[i]
